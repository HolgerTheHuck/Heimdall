...
> Status: **1.1.0** — alle Tests grün, live verifiziert (CI: Windows + Linux, .NET 8/9/10).
...
Signaturen ein. Version `1.1.0`, Target-Frameworks `net8.0;net9.0;net10.0`.
...
`dotnet add package Heimdall.Sdk` (bzw. `--version 1.1.0`). Für Pre-Release- oder
