...
public static class HeimdallI18n
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _table = new(256, StringComparer.Ordinal)
    {
        ...
        ["trace.col.timeline"]    = Lang("Zeitstrahl", "Timeline", "Frise chronologique"),
        ["trace.span.count"]      = Lang("{0} Spans", "{0} spans", "{0} spans"),
        ["trace.timeline.aria"]   = Lang("Histogramm der Span-Starts über die Trace-Dauer", "Histogram of span starts over the trace duration", "Histogramme des débuts de spans sur la durée de la trace"),
        ["trace.timeline.bucket"] = Lang("{0} Spans · {1} bis {2}", "{0} spans · {1} to {2}", "{0} spans · {1} à {2}"),
