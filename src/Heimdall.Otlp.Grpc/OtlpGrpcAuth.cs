...
/// <see cref="StatusCode.Unauthenticated"/> — gRPC-Idiom statt HTTP-401. Vergleich
/// zeitkonstant via <see cref="SecretComparer"/>.
/// </summary>
internal static class OtlpGrpcAuth
{
    public static void EnsureAuthorized(ServerCallContext context, HeimdallOtlpGrpcOptions? opts)
    {
        ...
        if (entry is null || !SecretComparer.Equals(entry.Value, opts.ApiKey))
        {
